insertion: Insertion es una funcion que agrega un elemento nuevo al final de una lista. Para hacer esto tiene que recorrer la lista completa de inicio a fin, por lo que es una funcion de complejidad O(n).
